      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className={style.filter}>
            ...
            <div>
              <CustomSelect
                ...
                options={[
                  ...
                  {label: 'Phone', value: 'phone 2'},
                ]}
                data={filter.method}
                onChange={value => handlePropsChange('method', value)}
              />
            </div>
            <div>
              <CustomSelect
                ...
                options={[
                  ...
                  {label: 'Requested review', value: 'requested'},
            ...
            <div>
              <CustomSelect
                placeholder={t('select_review_status')}
                options={[
                  {label: 'Review', value: 'review'},
                ...
                onChange={value => handlePropsChange('review_status', value)}
              />
            </div>
            <div>
              <Field
